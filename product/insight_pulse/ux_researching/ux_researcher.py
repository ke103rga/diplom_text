...
class UXResearcher:
    ...
    def plot_step_matrix_difference(self, segment1, segment2, data: Optional[EventFrame] = None,
        ...
        return self.step_matrix.plot_difference(segment1, segment2, data, max_steps, threshold, weight_col, target_events, title)
    ...
    def describe_events(self, ef: EventFrame, events: Optional[List[str]] = None, add_session_stats: bool = True) -> pd.DataFrame:
    ...
    def plot_lifetime_hist(self, ef: EventFrame, max_return_time: Optional[Union[int, TimeUnits, Tuple[int, str]]],
        ...
        return self.desc_stats_analyzer.plot_lifetime_hist(ef, max_return_time, plot_period, lower_cutoff_quantile, upper_cutoff_quantile, **hist_kwargs)

    def plot_event_distance_hist(self, ef: EventFrame, event_from: Union[str, List[str]], event_to: Union[str, List[str]],
                                 plot_period: Union[str, TimeUnitPeriod] = 'D', lower_cutoff_quantile: Optional[float] = None,
                                 upper_cutoff_quantile: Optional[float] = None, **hist_kwargs) -> None:
        return self.desc_stats_analyzer.plot_event_distance_hist(ef, event_from, event_to, plot_period, lower_cutoff_quantile, upper_cutoff_quantile, **hist_kwargs)